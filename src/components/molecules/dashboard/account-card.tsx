...
const AccountCard = ({ user }: { user: User }) => {
  ...
  return (
    ...
    >
      <h4 className="font-medium text-xxs md:text-xs leading-6 text-muted-200">
        account details
      </h4>
      ...
      <div className="text-foreground-300 font-medium text-xxs md:text-xs leading-6">
        ...
        <div className="flex justify-between items-center gap-x-2 md:gap-x-4">
          <p className="text-lg md:text-xl leading-snug font-semibold">{accountNumber}</p>
      ...
      <p className="text-foreground-300 font-medium text-xxs md:text-xs leading-6">
        {accountName}
      </p>
    </div>
  );
